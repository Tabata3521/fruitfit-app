...
export default function BottomNavigation({ active = "home", onNavigate }) {
  return (
    <nav className="fixed bottom-0 left-1/2 z-40 w-full max-w-[393px] -translate-x-1/2 border-t border-appBorder bg-appCard/92 px-4 pb-[max(12px,env(safe-area-inset-bottom))] pt-2 backdrop-blur-md">
